    ...
    <div class="vertical-align-middle">
        <div class="auth-box ">
            <div class="left">
                <div class="content">
                    <div class="header">
                        <div class="logo text-center"><img src="{{ asset('sb-admin2/img/pku_brand.png') }}" alt="PKU Logo"></div>
                        <p class="lead">Masuk Sebagai Bidan</p>
                    </div>
                    <form class="form-auth-small" method="POST" action="{{ route('post.login.kebidanan') }}">
                        @csrf
